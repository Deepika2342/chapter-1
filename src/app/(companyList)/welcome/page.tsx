        ...
        <div className="fixed top-0 left-0 w-full h-full overflow-hidden bg-[#E0F4EC]">
            ...
            <div className="flex flex-col flex-1 h-full">
                <div className="flex-1 mt-4 bg-white">
                    ...
                    {/* Sidebar */}
                    <div
                        className={`fixed top-[130px] right-0 h-full w-[220px] bg-white shadow-md transition-transform duration-300 ease-in-out z-50 ${menuOpen ? "translate-x-0" : "translate-x-full"
                            }`}
                    >
