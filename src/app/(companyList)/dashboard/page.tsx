        ...
        <div className="flex-1 grid grid-cols-3 gap-3 p-4 overflow-y-auto">
          ...
          <div className="col-span-2 space-y-4">
            ...
            <div className="bg-white p-4 border border-border">
              <div className="flex justify-between items-center border-b border-border pb-2 mb-3">
                ...
                <button className="flex items-center text-sm border border-gray-300 bg-gray-100 px-2 py-1 hover:bg-gray-200">
                  Today
              ...
              <div className="flex justify-between items-center text-sm mb-4">
                <div className="flex gap-1">
                  <button className="px-3 py-1 border border-border bg-border">
                    SALES
                  </button>
                  <button className="px-3 py-1 border border-border bg-border">
                    PURCHASE
            ...
            <div className="bg-white p-4 border border-border">
              ...
              <button className="flex items-center text-sm border border-gray-300 bg-gray-100 px-2 py-1 hover:bg-gray-200 mb-3">
                Today
                <IoMdArrowDropdown className="ml-1" />
              </button>
          ...
          <div className="space-y-4 mb-5">
            ...
            <div className="bg-white border border-border p-3">
              ...
              <div className="space-y-2 h-64 overflow-y-auto">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-gray-100 border border-border p-2"
                  >
            ...
            <div className="bg-white border border-border p-3 shadow-sm">
              ...
              <button className="w-full mt-4 py-2 border border-gray-300 text-white bg-[#105F62] font-medium text-sm">
                ADD BANK
              </button>
            </div>
