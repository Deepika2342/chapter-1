      ...
      <div className="flex items-center gap-3 sm:gap-6 flex-1 min-w-0">
        ...
        <div className="relative flex-1 sm:flex-none min-w-0" ref={companyRef}>
          <button
            ...
            className="flex items-center gap-1 text-sm font-semibold text-gray-800  top-0 max-w-[120px] sm:max-w-none truncate border border-gray-300 px-3 py-2 rounded hover:bg-gray-100 w-full"
          >
          ...
          {companyDropdownOpen && (
            <div className="absolute top-1 w-full sm:w-96 bg-white border border-border rounded-none z-50">
              <div className="flex items-center gap-2 px-2 py-1 border-b border-border">
                <input
                  ...
                  autoFocus
                />
                <FaSearch className="text-gray-500 text-2xl sm:text-m" />
              </div>
